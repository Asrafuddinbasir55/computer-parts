...
import madarborad from '../../assets/images/madarborad.png.png';
    ...
    return (
        ...
        className='flex justify-center items-center'>
            <div className='flex-1 hidden lg:block'>
                <img className='my-[100px] mx-5' src={madarborad} alt="" />
            </div>
            <div className='flex-1 px-5 mx-5'>
                <h3 className='text-xl text-primary font-bold'>Madarborad</h3>
                <h2 className='text-3xl  py-5'>Our Madarborad Computer</h2>
